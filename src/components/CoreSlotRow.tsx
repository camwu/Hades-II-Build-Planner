...
export function CoreSlotRow({ slot, boon, isActive, onClick, onRemove, draggedBoon, isValid, shouldGlowWhite }: CoreSlotRowProps) {
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <div
              className={`absolute inset-0 rounded-[inherit] bg-white/[0.02] ring-[3px] ring-white/30 shadow-[0_0_24px_rgba(255,255,255,0.30)] animate-white-ring-pulse z-20 pointer-events-none transition-opacity duration-200 ${
                (!(shouldHighlight || isActive || isPotentialTarget) && shouldGlowWhite) ? 'opacity-100' : 'opacity-0'
              }`}
            />
